...
INSERT INTO person (person_name) VALUES ('Bella Cugini');
UPDATE movie SET director_id = (SELECT person_id FROM person WHERE person_name = 'Bella Cugini') WHERE title = 'The Blob';