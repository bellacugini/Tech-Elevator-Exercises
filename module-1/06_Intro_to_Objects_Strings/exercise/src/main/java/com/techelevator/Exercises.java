...
public class Exercises {
	...
	public String makeOutWord(String out, String word) {
		...
		String output = beginning + word + end;
		return output;
	}
	...
	public String firstHalf(String str) {
		...
		String output = str.substring(0, half);
		return output;
	}
	...
	public String nonStart(String a, String b) {
		String output = a.substring(1) + b.substring(1);
		return output;
	}
	...
	public String left2(String str) {
		...
		String output = str.substring(2) + leftTwo;
		return output;
	}
	...
	public String right2(String str) {
		...
		String output = rightTwo + str.substring(0, str.length()-2);
		return output;
	}
	...
	public boolean endsLy(String str) {
		...
		else if(str.substring(length-2).equals(ly)){
			return true;
		}
		else{
			return false;
