...
public class Exercises {
	...
	** INTERVIEW QUESTION **
	...
	public List<String> fizzBuzzList(Integer[] integerArray) {
		// new list contains same values as array but converted into strings
		// if value is multiple of 3 - replace String with "Fizz"
		// if value is multiple of 5 - replace String with "Buzz"
		// if value is both multiple of 3 and 5 - replace string with "FizzBuzz"
		...
		for(int i = 0; i < integerArray.length; i++){
			if((integerArray[i] % 3) == 0 && (integerArray[i] % 5) == 0){
				...
				arrayList.add(integerArray[i].toString());
			}
		}
